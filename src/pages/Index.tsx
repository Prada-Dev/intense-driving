      ...
      <section className="relative text-white py-20 px-4 min-h-[600px] flex items-center">
        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white px-8 py-3 text-lg bg-blue-700 hover:bg-blue-600 text-slate-100 rounded">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {courses.map((course, index) => <Card key={index} className="hover:shadow-xl transition-shadow duration-300 border-2 hover:border-blue-200">
                <CardHeader>
                ...
                <CardContent>
                  <ul className="space-y-2 mb-6">
                    {course.features.map((feature, idx) => <li key={idx} className="flex items-center text-sm text-gray-700">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button variant="outline" className="w-full" asChild>
                      <Link to={course.title === "Beginner Course" ? "/courses/beginner" : course.title === "Intensive Course" ? "/courses/intensive" : "/courses"}>
                        Learn More
                      </Link>
                    </Button>
                  </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <img src={drivingCarImage} alt="Professional driving instruction" className="rounded-lg shadow-xl" />
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 relative">
              <img src={successStoryImage} alt="Student success stories" className="rounded-lg shadow-xl" />
            </div>
